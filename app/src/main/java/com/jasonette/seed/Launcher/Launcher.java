...
public class Launcher extends Application implements ProviderInstaller.ProviderInstallListener{
    ...
    public void onCreate() {
        super.onCreate();
        ProviderInstaller.installIfNeededAsync(this, this); /**added by abs.jabed for fixing bug on network call (13/05/2019)**/
    ...
    /**added by abs.jabed for avoiding crash on android <= 4.4 on 13/05/2019**/
    @Override
     ...
     */
    /**added by abs.jabed for fixing bug on network call (13/05/2019)**/
    @Override
    public void onProviderInstalled() {
        // Provider is up-to-date, app can make secure network calls.
        //Toast.makeText(currentContext, "provider up-to-date", Toast.LENGTH_SHORT).show();
        Log.d("jsn_provider status", "-> up-to-date");
    }
...
/*
    ...
    private void onProviderInstallerNotAvailable() {
        ...
        // appropriate action.
        Log.d("jsn_provider status", "-> ProviderInstallerNotAvailable");
    }
